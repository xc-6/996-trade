...
<img src="./trade-record-demo.gif" alt="演示" width="800" height="600">
...
该项目使用 [`next/font`](https://nextjs.org/docs/app/building-your-application/optimizing/fonts) 来自动优化和加载 [Geist](https://vercel.com/font) 字体，这是 Vercel 推出的新字体系列。
...
你也可以查看 [Next.js GitHub 仓库](https://github.com/vercel/next.js) - 欢迎你的反馈和贡献！
